...
const STRINGS = {
  he: {
    ...
    required: 'חובה',
    teamScope: 'מארק (FRC/FTC)', teamScopeHint: 'סימון תוכנית: פריטים משותפים תמיד מוצגים בשתי האפשרויות.',
    ...
    or: 'או', enterAsParent: 'כניסת הורים (צפייה בלבד)', parentViewHint: 'צפייה בלוח הבקרה ובתנועות בלבד, ללא שמות משלמים וללא קבלות.',
    guestSignInFailed: 'כניסת האורחים אינה מופעלת. יש להפעיל Anonymous sign-ins בהגדרות Supabase.',
  ...
  en: {
    ...
    or: 'or', enterAsParent: 'Parent view (read-only)', parentViewHint: 'Dashboard and transactions only — no payer names, no receipts.',
    guestSignInFailed: 'Guest access is not enabled. Turn on Anonymous sign-ins in Supabase settings.',
