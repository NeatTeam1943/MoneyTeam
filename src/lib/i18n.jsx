...
const STRINGS = {
  he: {
    ...
    loading: 'טוען…',
    downloadReceipts: 'הורדת קבלות', noReceipts: 'אין קבלות להורדה',
    ...
    pending_approval: 'ממתין לאישור', requestedByCategory: 'מבוקש לפי קטגוריה', actualByCategory: 'בפועל לפי קטגוריה', requestedByStatus: 'מבוקש לפי סטטוס',
  ...
  en: {
    ...
    loading: 'Loading…',
    downloadReceipts: 'Download receipts', noReceipts: 'No receipts to download',
    ...
    pending_approval: 'Pending approval', requestedByCategory: 'Requested by category', actualByCategory: 'Actual by category', requestedByStatus: 'Requested by status',
