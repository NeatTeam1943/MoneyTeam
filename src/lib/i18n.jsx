...
const STRINGS = {
  he: {
    ...
    welcomeSetPassword: 'ברוכים הבאים!', setPasswordHint: 'לפני שממשיכים, קבעו סיסמה לחשבון שלכם.',
    newPassword: 'סיסמה חדשה', confirmPassword: 'אימות סיסמה', setPasswordAndContinue: 'קביעת סיסמה והמשך',
    passwordTooShort: 'הסיסמה חייבת לכלול לפחות 6 תווים', passwordsDontMatch: 'הסיסמאות אינן תואמות',
    importCsv: 'ייבוא מ-CSV', noValidRowsInCsv: 'לא נמצאו שורות תקינות בקובץ', csvImportResult: 'נשלחו {ok} הזמנות, {failed} נכשלו',
    downloadTemplate: 'הורדת תבנית', chooseFile: 'בחירת קובץ',
    csvFormatExplain: 'כל שורה בקובץ: אימייל, שם (השם רשות). ניתן לכלול שורת כותרת — היא תזוהה ותידלג עליה אוטומטית. כולם יוזמנו כתלמידים.',
    csvFormatNote: 'דוגמה לקובץ תקין:',
  ...
  en: {
    ...
    welcomeSetPassword: 'Welcome!', setPasswordHint: 'Before you continue, set a password for your account.',
    newPassword: 'New password', confirmPassword: 'Confirm password', setPasswordAndContinue: 'Set password & continue',
    passwordTooShort: 'Password must be at least 6 characters', passwordsDontMatch: 'Passwords don\'t match',
    importCsv: 'Import CSV', noValidRowsInCsv: 'No valid rows found in that file', csvImportResult: 'Sent {ok} invites, {failed} failed',
    downloadTemplate: 'Download template', chooseFile: 'Choose file',
    csvFormatExplain: 'Each line: email, name (name is optional). A header row is fine — it\'s detected and skipped automatically. Everyone is invited as a student.',
    csvFormatNote: 'Example of a valid file:',
