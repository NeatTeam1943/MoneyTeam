...
const STRINGS = {
  he: {
    ...
    downloadReceipts: 'הורדת קבלות', noReceipts: 'אין קבלות להורדה', payer: 'שולם ע"י', payerHint: 'שם התלמיד/ה או המשלם (גלוי למנטורים בלבד)',
  ...
  en: {
    ...
    downloadReceipts: 'Download receipts', noReceipts: 'No receipts to download', payer: 'Paid by', payerHint: "Student or payer's name (visible to mentors only)",
